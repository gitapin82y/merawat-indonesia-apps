...
@section('content')
    ...
    <ul class="list-group pt-2" style="padding-bottom:600px;">
        <a href="" class="list-group-item py-0 my-2 d-flex align-items-center">
        ...
        @foreach($categories as $category)
                <a href="{{ url('/kampanye') }}?category={{ urlencode($category->name) }}" class="list-group-item py-0 my-2 d-flex align-items-center">
                    <div class="icon-card me-2">
