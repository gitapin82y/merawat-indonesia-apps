...
@section('content')
    ...
    @include('includes.public.navbar-back', ['title' => 'Edit Profile'])
        ...
        <div class="container mt-4 flex-grow-1" style="padding-bottom: 170px">
            <form id="formData" action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            ...
            <div class="mb-3 position-relative">
                <div class="form-floating">
                    <input type="text" class="form-control bg-white @error('thumbnail') is-invalid @enderror" id="thumbnailProfil"
                        placeholder="Ubah Thumbnail Profil?" style="padding-right: 120px; pointer-events: none;" readonly>
                    <label for="thumbnailProfil">Ubah Thumbnail Profil?</label>
                </div>
        ...
        <div id="thumbnailPreviewContainer" class="mb-3" style="display: none;">
            ...
            <div class="mb-3 position-relative">
                <div class="form-floating">
                    <input type="text" class="form-control bg-white @error('avatar') is-invalid @enderror" id="avatarProfil" placeholder="Ubah Avatar Profil?"
                        style="padding-right: 120px; pointer-events: none;" readonly>
                    <label for="avatarProfil">Ubah Avatar Profil?</label>
                </div>
        ...
        <div id="avatarPreviewContainer" class="mb-3" style="display: none;">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama" required value="{{ old('name',$user->name) }}" />
            ...
            <!-- Nomor Telepon -->
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="Nomor Telepon" required value="{{ old('phone',$user->phone) }}" />
 ...
 $(document).ready(function() {
        $('#submitForm').on('click', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Apakah Anda yakin ingin mengganti profile user galang dana?',
                icon: 'question',
