...
@section('meta_tags')
    ...
    <meta name="description" content="{{ \Illuminate\Support\Str::limit(html_entity_decode(strip_tags($campaign->description)), 160) }}">
    ...
    <meta property="og:description" content="{{ \Illuminate\Support\Str::limit(html_entity_decode(strip_tags($campaign->description)), 160) }}">
    ...
    <meta name="twitter:description" content="{{ \Illuminate\Support\Str::limit(html_entity_decode(strip_tags($campaign->description)), 160) }}">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "DonateAction",
        "name": "{{ $campaign->title }}",
        "description": "{{ \Illuminate\Support\Str::limit(html_entity_decode(strip_tags($campaign->description)), 160) }}",
