<!-- resources/views/emails/fundraising-withdrawal.blade.php -->
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Permintaan Pencairan Dana Fundraising</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Permintaan Pencairan Dana Fundraising</h1>
        </div>
        <div class="content">
            <p>Halo Admin,</p>
            
            <p>Ada permintaan pencairan dana fundraising baru yang memerlukan persetujuan Anda.</p>
            
            <div class="withdrawal-info">
                <div class="withdrawal-detail">
                    <strong>Nama User:</strong> {{ $withdrawal->user->name }}
                </div>
                <div class="withdrawal-detail">
                    <strong>Email:</strong> {{ $withdrawal->user->email }}
                </div>
                <div class="withdrawal-detail">
            ...
            <div style="text-align: center;">
                <a href="{{ route('pencairan-fundraising.index') }}" class="button">Kelola Pencairan Dana</a>
            </div>
        </div>
        <div class="footer">
