        ...
        <div class="container mt-4 flex-grow-1">
            <div class="alert alert-light shadow-sm d-flex align-items-center bg-white">
                ...
                <div>
                    ...
                    <p class="mb-0">
                        Membuat akun galang dana memerlukan verifikasi akun dari admin terlebih dahulu sebelum
                        membuka kampanye.
                    </p>
                </div>
            </div>

            <form action="{{ route('kampanye.store') }}" 
                ...
                <div class="mb-3 position-relative">
                    <div class="form-floating">
                        <input type="text" class="form-control bg-white" id="photo"
                            placeholder="Thumbnail Kampanye" style="padding-right: 120px; pointer-events: none;"
                            readonly>
                        <label for="photo">Thumbnail Kampanye</label>
                    </div>
                    <input type="file" accept="image/*" id="filePhoto" name="photo" class="d-none @error('photo') is-invalid @enderror"
            ...
            @enderror
                ...
                <div class="upload-info mb-3">
                    <p>  Berikan keterangan atau cerita lengkap dengan bukti foto serta laporan RAB agar donatur dan admin lebih percaya dengan kampanye anda</p>
                </div>
            </form>
    ...
    $(document).ready(function() {
        $('#submitForm').on('click', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Membuat Kampanye Memerlukan Validasi dari Admin 1x24 Jam',
                icon: 'question',
