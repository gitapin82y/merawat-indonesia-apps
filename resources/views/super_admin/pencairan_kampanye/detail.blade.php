                ...
                <div class="p-4 bg-light rounded">
                    ...
                    <div class="mb-4">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">Rp {{ number_format($pencairanKampanye->campaign->current_donation + $pencairanKampanye->amount, 0, ',', '.') }}</div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">Rp {{ number_format($pencairanKampanye->campaign->current_donation, 0, ',', '.') }}</div>
                        </div>
                    </div>
