                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                ...
                                @if(isset($user->id) && $user->avatar)
                                    <a href="javascript:void(0)" class="ms-2 text-primary" onclick="previewImage('{{ $user->avatar_url }}', 'Avatar')">
                                        <small>(Lihat)</small>
                                    </a>
                                @endif
                            </label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                ...
                                @if(isset($user->id) && $user->thumbnail)
                                    <a href="javascript:void(0)" class="ms-2 text-primary" onclick="previewImage('{{ $user->thumbnail_url }}', 'Thumbnail')">
                                        <small>(Lihat)</small>
                                    </a>
                                @endif
                            </label>
