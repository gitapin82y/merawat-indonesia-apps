    ...
    <div class="card mb-4">
        <div class="card-header bg-white py-3 align-items-center justify-content-between row m-0">
            <div class="col-12 col-sm-6 p-0">
                <h4 class="m-0 font-weight-bold float-left text-danger">Request Pencairan Dana Fundraising</h4>
            </div>
        </div>
        <div class="card-body">
...
$(function () {
    var table = $('.yajra-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('pencairan-fundraising.index') }}",
        columns: [
...
function deletePencairanFundraising(id) {
    Swal.fire({
        title: 'Apakah Anda yakin?',
